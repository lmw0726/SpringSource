...
/**
 * {@link ConcurrentTaskScheduler} 的基于 JNDI 的变体，在 Java EE 7 环境中执行对
 * JSR-236 的 "java:comp/DefaultManagedScheduledExecutorService" 的默认查找。
 *
 * <p>注意：此类并非严格基于 JSR-236；它可以与任何可在 JNDI 中找到的普通
 * {@link java.util.concurrent.ScheduledExecutorService} 配合使用。
 * 实际对 {@link javax.enterprise.concurrent.ManagedScheduledExecutorService} 的适配
 * 发生在基类 {@link ConcurrentTaskScheduler} 本身中。
 *
...
public class DefaultManagedTaskScheduler extends ConcurrentTaskScheduler implements InitializingBean {
	 ...
	 * 替换默认的 JNDI 名称 "java:comp/DefaultManagedScheduledExecutorService"。
